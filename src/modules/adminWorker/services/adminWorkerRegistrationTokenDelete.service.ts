...
@injectable()
class AdminWorkerRegistrationTokenDeleteService {
  constructor(
  ...
  public async execute({
    ...
    const workerRegistrationToken =
      await this.workerRegistrationTokenRepository.deleteOne({
    ...
    if (!workerRegistrationToken)
      throw new AppError({
        ...
        message: t(
          "@admin_worker_registration_token_delete_service/WORKER_REGISTRATION_TOKEN_NOT_FOUND",
...
export { AdminWorkerRegistrationTokenDeleteService };
