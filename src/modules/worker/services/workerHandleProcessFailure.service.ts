...
@injectable()
class WorkerHandleProcessFailureService {
  constructor(
  ...
  public async execute({
    ...
    if (!processing)
      throw new AppError({
        key: "@worker_handle_process_failure_service/PROCESSING_NOT_FOUND",
    ...
    if (!updatedProcessing)
      throw new AppError({
        key: "@worker_handle_process_failure_service/PROCESSING_UPDATE_FAILED",
...
export { WorkerHandleProcessFailureService };
