...
describe("Service: WorkerGenerateProcessingMetricsUploadFileService", () => {
  ...
  let workerGenerateProcessingMetricsUploadFileService: WorkerGenerateProcessingMetricsUploadFileService;
