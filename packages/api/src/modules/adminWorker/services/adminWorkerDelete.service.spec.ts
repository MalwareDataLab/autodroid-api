...
describe("Service: AdminWorkerDeleteService", () => {
  ...
  beforeEach(() => {
    ...
    adminWorkerDeleteService = new AdminWorkerDeleteService(
      workerRepositoryMock,
    );
  });
  ...
  it("should delete a worker", async () => {
    ...
    workerRepositoryMock.deleteOne.mockResolvedValueOnce(worker);
  ...
  it("should throw if the worker was not found", async () => {
    ...
    workerRepositoryMock.deleteOne.mockResolvedValueOnce(null);
